...
public class LesoukApplication implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        Annonce annonce1= new Annonce("TV 4K", "Neuve, 4K", 450.00, 3);
        ...
        Annonce annonce2= new Annonce("Canard de bain", "Jaune, flotte", 3.00, 1);
        ...
        Annonce annonce3= new Annonce("Table + chaises", "Table blanche avec 4 chaises laquees", 100.00, 2);
